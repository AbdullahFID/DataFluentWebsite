// components/backgrounds/FloatingLines.tsx
'use client';
...
type FloatingLinesProps = {
  ...
  maxDpr?: number;           // Cap device pixel ratio (default: 1.5)
  targetFps?: number;        // Target frame rate (default: 30)
  paused?: boolean;          // Pause rendering entirely
};
...
function FloatingLines({
  ...
  }, [linesGradient, enabledWaves, lineCount, lineDistance, topWavePosition, middleWavePosition, bottomWavePosition, animationSpeed, interactive, bendRadius, bendStrength, mouseDamping, parallax, parallaxStrength, maxDpr, targetFps, paused, topLineCount, middleLineCount, bottomLineCount, topLineDistance, middleLineDistance, bottomLineDistance]);
