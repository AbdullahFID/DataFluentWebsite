...
export const BRAND_COLORS = {
  ...
  // Metaballs-only (not used in loader)
  tesla: ['#E82127', '#FFFFFF', '#CC0000'],
...
/**
 * Datafluent• letter indices (loader only — 5 companies):
 * 0 D, 1 a, 2 t, 3 a, 4 f, 5 l, 6 u, 7 e, 8 n, 9 t, 10 •
 */
export const LOGO_LETTER_TARGETS: Record<string, readonly number[]> = {
  google: [0, 1, 2, 3],
  apple: [4],
  meta: [5, 6],
  microsoft: [7, 8],
...
// Only 5 companies for the loader animation
...
/**
 * Generate random position for logo spawn
 */
